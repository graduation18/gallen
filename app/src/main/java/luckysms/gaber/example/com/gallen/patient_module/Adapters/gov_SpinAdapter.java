...
public class gov_SpinAdapter extends RecyclerView.Adapter<gov_SpinAdapter.MyViewHolder>  {

    private Context context;
    private List<patient_gov_model> contact_list;

    public void filterList(ArrayList<patient_gov_model> filteredList) {
    ...
    public gov_SpinAdapter(Context context, List<patient_gov_model> contact_list) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        patient_gov_model data = contact_list.get(position);

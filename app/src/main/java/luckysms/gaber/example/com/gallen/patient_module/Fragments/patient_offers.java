...
public class patient_offers extends Fragment  {
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.patient_offers_fragment, container, false);
        ...
        /*if (getActivity().getSharedPreferences("personal_data",Context.MODE_PRIVATE).getInt("id",0)!=0) {
            ...
            get_offers(getActivity().getSharedPreferences("personal_data",MODE_PRIVATE).getInt("id",0));
        }*/
        return view;
    }

    private void get_offers(final int patient_id)
    {
